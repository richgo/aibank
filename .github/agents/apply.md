---
name: apply
description: 'Implement tasks using strict TDD red-green-refactor. For each task: write a failing test, write minimum code to pass, refactor, commit on green. Repeats until all tasks are complete.'
