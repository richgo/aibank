...
- [ ] **2.1** Implement Google Maps MCP client function
...
- [ ] **2.3** Add transaction location intent detection
...
- [ ] **2.4** Extract merchant name from user query
...
- [ ] **2.5** Implement transaction location flow in runtime
...
- [ ] **2.6** Create transaction location A2UI template
...
- [ ] **2.7** Add transaction_location template to allowed list
...
- [ ] **2.8** Update agent card with Google Maps catalog
...
- [ ] **3.1** Create googlemaps catalog directory structure
  Create `app/lib/catalog/googlemaps/` directory for MCP-App components.

- [ ] **3.2** Implement MapView catalog item
...
- [ ] **3.3** Implement MapView widget with FlutterMap
...
- [ ] **3.4** Style MapView marker with app theme
...
- [ ] **3.5** Create MCP-App catalog builder
...
- [ ] **3.6** Register MCP-App catalog in banking catalogs
...
- [ ] **4.1** Write unit tests for geocode_merchant
...
- [ ] **4.2** Write unit tests for transaction location intent
...
- [ ] **4.3** Write unit tests for merchant extraction
...
- [ ] **4.4** Write widget tests for MapView
...
- [ ] **4.5** Write integration test for transaction location flow
...
- [ ] **4.6** Validate transaction_location.json template
...
- [ ] **5.3** Verify non-geocodable merchant handling
